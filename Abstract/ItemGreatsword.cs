    ...
    public abstract class ItemGreatsword : ModItem
    {
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			foreach (TooltipLine line in tooltips)
			{
				...
				{
					line.text = (int)((gStats.GetDmg() * 0.6) * (float)player.GetDamage(DamageClass.Melee)) + " Light Melee Damage\n" + (int)((gStats.GetDmg() * 2.5) * (float)player.GetDamage(DamageClass.Melee)) + " Heavy Melee Damage";
				}
