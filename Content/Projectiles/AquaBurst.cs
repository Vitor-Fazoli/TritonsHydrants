...
namespace TritonsHydrants.Content.Projectiles
{
    public class AquaBurst : ModProjectile
    {
        ...
        private const float PiBeamDivisor = MathHelper.Pi / AquaBurstHoldout.NumBeams;
        ...
        public override void AI()
        {
            ...
            if (Projectile.type != ModContent.ProjectileType<AquaBurstHoldout>() || !hostPrism.active || hostPrism.type != ModContent.ProjectileType<AquaBurst>())
            {
                Projectile.Kill();
                return;
            }
            ...
            float chargeRatio = MathHelper.Clamp(hostPrism.ai[0] / AquaBurstHoldout.MaxCharge, 0f, 1f);
            ...
            Projectile.friendly = hostPrism.ai[0] > AquaBurstHoldout.DamageStart;

            // This offset is used to make each individual beam orient differently based on its Beam ID.
            float beamIdOffset = BeamID - AquaBurstHoldout.NumBeams / 2f + 0.5f;
            float beamSpread;
            float spinRate;
            ...
            float deviationAngle = (hostPrism.ai[0] + beamIdOffset * spinRate) / (spinRate * AquaBurstHoldout.NumBeams) * MathHelper.TwoPi;
            ...
            Terraria.Utils.PlotTileLine(Projectile.Center, Projectile.Center + Projectile.velocity * BeamLength, beamDims.Y, new Terraria.Utils.TileActionAttempt(DelegateMethods.CastLight));
        }
        ...
        {
            Terraria.Utils.LaserLineFraming lineFraming = new Terraria.Utils.LaserLineFraming(DelegateMethods.RainbowLaserDraw);
        ...
        private Color GetOuterBeamColor()
        {
            ...
            float hue = (BeamID / AquaBurstHoldout.NumBeams) % BeamHueVariance + BeamColorHue;
        ...
        private Color GetInnerBeamColor() => Water.GetWaterColor();
