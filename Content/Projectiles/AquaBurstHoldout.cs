...
{
    public class AquaBurstHoldout : ModProjectile
    {
        ...
        private void FireBeams()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<AquaBurst>(), damage, knockback, Projectile.owner, b, uuid);
            }
