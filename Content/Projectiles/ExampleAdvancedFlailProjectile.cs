...
namespace DevilsWarehouse.Content.Projectiles
{
    ...
    {
        private const string ChainTexturePath = "DevilsWarehouse/Content/Projectiles/ExampleAdvancedFlailProjectileChain"; // The folder path to the flail chain sprite
        private const string ChainTextureExtraPath = "DevilsWarehouse/Content/Projectiles/ExampleAdvancedFlailProjectileChainExtra";  // This texture and related code is optional and used for a unique effect
        ...
        public override void AI()
        {
                ...
                case AIState.Spinning:
                    {
                        ...
                        Vector2 offsetFromPlayer = new Vector2(player.direction).RotatedBy((float)Math.PI * 6f * (SpinningStateTimer / 60f) * player.direction);
                        ...
                        Projectile.Center = mountedCenter + offsetFromPlayer * 45f;
			...
			*/
            ...
            if (Main.rand.NextBool(dustRate))
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.AmberBolt, 0f, 0f, 150, default(Color), 1.3f);
        }
