...
namespace ExampleMod.Content.Biomes {
	public class FUngalLand : ModBiome {
		...
		// Select Music
		//public override int Music => MusicLoader.;
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Fungal Lands");
		}
		...
		public override bool IsBiomeActive(Player player) {
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) &&
				...
				//ModContent.GetInstance<FungalTileCount>().fungalBlockCount >= 40 &&
