...
namespace DevilsWarehouse.Content.UI
{
    class VampireUI : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            barFrame = new UIImage(ModContent.Request<Texture2D>("DevilsWarehouse/Assets/Textures/VampireUI"));
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            {
                spriteBatch.Draw((Texture2D)TextureAssets.MagicPixel, new Rectangle(hitbox.X, hitbox.Bottom - i, 25, hitbox.Height), new Color(200, 0, 255));
