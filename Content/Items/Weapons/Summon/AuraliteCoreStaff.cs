...
namespace GearonArsenal.Content.Items.Weapons.Summon
{
	public class WanderingAuraliteBuff : ModBuff
	{
		...
		{
			if (player.ownedProjectileCounts[ModContent.ProjectileType<WanderingAuralite>()] > 0)
			{
	...
	public class AuraliteCoreStaff : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Auralite Core Staff");
	...
	public class WanderingAuralite : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Wandering Auralite");
