...
namespace GearonArsenal.Content.NPCs.Enemies
{
    internal class ValkyrieBot : ModNPC
    {
        ...
        {
            return ModContent.NPCType<SteelValkyrie>();
        }

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Valkyrie Bot");
        ...
        private void MoveInFormation()
        {
            ...
            float rad = (float)PositionIndex / SteelValkyrie.MinionCount() * MathHelper.TwoPi;
            ...
            float distanceFromBody = parentNPC.width + NPC.width + 200;
