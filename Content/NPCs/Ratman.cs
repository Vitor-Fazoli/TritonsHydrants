...
//                .SetBiomeAffection<DesertBiome>(AffectionLevel.Love) // Example Person likes the Example Surface Biome
...
//                    if (Main.tile[x, y].WallType == WallID.Glass)
//                    {
//                        score++;
//                    }
//                }
...
//                return ModContent.Request<Texture2D>("VoidArsenal/Content/NPCs/ExamplePerson");

//            if (npc.altTexture == 1)
//                return ModContent.Request<Texture2D>("VoidArsenal/Content/NPCs/ExamplePerson_Party");

//            return ModContent.Request<Texture2D>("VoidArsenal/Content/NPCs/ExamplePerson");
//        }

//        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("VoidArsenal/Content/NPCs/ExamplePerson_Head");
//    }
//}