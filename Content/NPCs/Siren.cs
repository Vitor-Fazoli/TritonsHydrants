...
public class Siren : ModNPC
{
    ...
    public override string GetChat()
    {
        ...
        chat.Add(Language.GetTextValue("Mods.TritonsHydrants.Dialogue.Siren.StandardDialogue1"));
        chat.Add(Language.GetTextValue("Mods.TritonsHydrants.Dialogue.Siren.StandardDialogue2"));
        chat.Add(Language.GetTextValue("Mods.TritonsHydrants.Dialogue.Siren.StandardDialogue3"));
        return chat;
    }
